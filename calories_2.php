      ...
      <section class="mainContent">
        <div class="productRow">
          ...
          <article class="productInfo">
            ...
            // 設定SQL查詢字串
            $sql = "SELECT * FROM milk_c WHERE cal BETWEEN 200 AND 300";
            //送出UTF8編碼的MySQL指令
          ...
          <article class="productInfo">
            ...
            mysqli_select_db($link, "CSV_DB2");  // 選擇myschool資料庫
            // 設定SQL查詢字串
            $sql = "SELECT * FROM coco_c WHERE cal BETWEEN 200 AND 300";
            //送出UTF8編碼的MySQL指令
            mysqli_query($link, 'SET NAMES utf8');
            $result = mysqli_query($link, $sql);
            // 一筆一筆的以表格顯示記錄
          ...
          <article class="productInfo">
            ...
            mysqli_select_db($link, "CSV_DB2");  // 選擇myschool資料庫
            // 設定SQL查詢字串
            $sql = "SELECT * FROM macu_c WHERE cal BETWEEN 200 AND 300";
            //送出UTF8編碼的MySQL指令
            mysqli_query($link, 'SET NAMES utf8');
            $result = mysqli_query($link, $sql);
            // 一筆一筆的以表格顯示記錄
